...
CREATE TABLE `friend_requests` (
  ...
  `status` tinyint(1) DEFAULT NULL COMMENT '-1 - отклонён\n0 - запрос\n1 - принят',
...
CREATE TABLE `media` (
  ...
  `users_id` int unsigned NOT NULL,
  `url` varchar(45) DEFAULT NULL COMMENT '/files/x0d4/file.jpg',
  `file` blob,
...
INSERT INTO `media_types` VALUES (1,'1');
...
CREATE TABLE `posts` (
  ...
  `media_id` int unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_posts_posts1_idx` (`parent_post_id`),
  ...
  CONSTRAINT `fk_posts_posts1` FOREIGN KEY (`parent_post_id`) REFERENCES `posts` (`id`),
...
CREATE TABLE `profiles` (
  ...
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `media_id` int unsigned DEFAULT NULL COMMENT 'аватар',
...
-- Dump completed on 2021-01-22 23:06:58
